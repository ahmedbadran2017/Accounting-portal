...
const ICONS = {
  ...
  percent: "M19 5L5 19M7.5 7.5a2 2 0 100-.01M16.5 16.5a2 2 0 100-.01",
  ...
  package: "M21 8l-9-5-9 5v8l9 5 9-5zM3 8l9 5 9-5M12 13v10",
  inbox: "M3 13h5l1 3h6l1-3h5M3 13l2-8h14l2 8v6H3z",
