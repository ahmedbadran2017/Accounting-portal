...
export const SUBTABS = {
  ...
  items: [["items", "sub.items"], ["costtrace", "sub.costtrace"], ["weights", "sub.weights"], ["pricelists", "sub.pricelists"]],
  banking: [
  ...
  expenses: [],
  payroll: [],
  reports: [["pnlest", "sub.pnlest"], ["salescol", "sub.salescol"], ["arap", "sub.arap"], ["forecast", "sub.forecast"], ["missingdocs", "sub.missingdocs"], ["statements", "sub.statements"], ["investors", "sub.investors"], ["taxreports", "sub.taxreports"], ["dd", "sub.dd"], ["dataroom", "sub.dataroom"]],
  settings: [
